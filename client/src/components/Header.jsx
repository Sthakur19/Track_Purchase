...
function Header() {
  ...
  return (
    <nav className="bg-white border-gray-200 dark:bg-gray-900 fixed top-0 left-0 w-full z-50">
      <div className="flex flex-wrap items-center justify-between bg-[#356B6E] text-white p-4 z-40">
        <a
          href="#/"
        ...
        >
          ...
          <span className="self-center text-2xl font-semi whitespace-nowrap dark:text-white">
